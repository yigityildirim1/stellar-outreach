...
export function OnboardingScreen({ navigation }: RootStackProps<'Onboarding'>) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text style={styles.buttonText}>[ ENTER STATION ]</Text>
      </TouchableOpacity>

      <Text style={styles.version}>v0.1.0 — SCAFFOLD</Text>
    </View>
  );
}
